...
public class DomainNameserverConfiguration : IEntityTypeConfiguration<DomainNameserver>
{
	public void Configure(EntityTypeBuilder<DomainNameserver> builder)
	{
		builder.ToTable("DomainNameservers");
		builder.HasKey(e => new { e.DomainID, e.NameserverID });
