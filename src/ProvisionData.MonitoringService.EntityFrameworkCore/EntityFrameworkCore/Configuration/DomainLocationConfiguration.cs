...
public class DomainLocationConfiguration : IEntityTypeConfiguration<DomainLocation>
{
	public void Configure(EntityTypeBuilder<DomainLocation> builder)
	{
		builder.ToTable("DomainLocations");
		builder.HasKey(e => new { e.DomainID, e.LocationID });
