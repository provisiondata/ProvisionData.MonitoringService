...
public class MailExchangerConfiguration : IEntityTypeConfiguration<MailExchanger>
{
	public void Configure(EntityTypeBuilder<MailExchanger> builder)
	{
		builder.ToTable("MailExchangers");
