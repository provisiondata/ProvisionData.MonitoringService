...
public class MonitoringServiceApplicationModule : AbpModule
{
	[SuppressMessage("Style", "IDE0053:Use expression body for lambda expression", Justification = "<Pending>")]
	public override void ConfigureServices(ServiceConfigurationContext context)
	{
		context.Services.AddAutoMapperObjectMapper<MonitoringServiceApplicationModule>();
		Configure<AbpAutoMapperOptions>(options =>
		{
			options.AddMaps<MonitoringServiceApplicationModule>(validate: true);
		});
	}
}
