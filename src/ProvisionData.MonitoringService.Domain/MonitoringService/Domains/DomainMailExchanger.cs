...
public class DomainMailExchanger
{
	public Guid DomainID { get; set; }
	public Domain Domain { get; set; } = default!;

	public Guid MailExchangerID { get; set; }
	public MailExchanger MailExchanger { get; set; } = default!;

	public DateTimeOffset LastSeenUtc { get; set; }

	public override String ToString() => Domain + " <=> " + MailExchanger;
